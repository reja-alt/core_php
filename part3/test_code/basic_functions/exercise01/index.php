...
<html lang="en">
    ...
    <body class="bg-faded">
        ...
        <form class="form-group" action="" method="post">
            ...
            <input class="form-control form-control-lg mr-sm-2" type="text" value="<?php echo $thePizza ?>" placeholder="What will you eat?" name="pizza" id="pizza">
